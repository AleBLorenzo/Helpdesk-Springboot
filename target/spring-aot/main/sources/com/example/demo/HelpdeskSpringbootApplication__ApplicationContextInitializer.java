 ...
 */
@Generated
public class HelpdeskSpringbootApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new HelpdeskSpringbootApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new HelpdeskSpringbootApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
